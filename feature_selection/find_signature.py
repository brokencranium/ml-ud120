...
features_train_arr = features_train[:150].toarray()
labels_train_arr = labels_train[:150]

# your code goes here
from sklearn.tree import DecisionTreeClassifier
clf = DecisionTreeClassifier(random_state=0, min_samples_split=40)
clf.fit(features_train_arr, labels_train_arr)
print(len(clf.feature_importances_))
print(clf.feature_importances_.argmax())
print(features_train.data.item(clf.feature_importances_.argmax()))
